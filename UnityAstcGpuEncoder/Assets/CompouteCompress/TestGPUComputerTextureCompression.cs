...
using ASTCEncoderWithComputeShader;
using UnityEngine;
using UnityEngine.Experimental.Rendering;
using UnityEngine.Rendering;

public class TestGPUComputerTextureCompression : MonoBehaviour
{
    public ComputeShader m_CompressShader;
    public Texture m_SourceTexture;

    private GPUComputerTextureCompressor m_TextureCompressor;
    ...
    private void Awake()
    {
        m_TextureCompressor = GetComponent<GPUComputerTextureCompressor>();
    }
